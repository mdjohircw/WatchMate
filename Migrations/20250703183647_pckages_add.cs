...
{
    /// <inheritdoc />
    public partial class pckages_add : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MaxDailyViews = table.Column<int>(type: "int", nullable: true),
                    PerAdReward = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
